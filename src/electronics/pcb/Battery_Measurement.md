...
The utility of this  work is  that  we need to know when the battery  is  charged to less than 17 V  , when it is less than 17 V  a buzzer will work as an alarm with blinking of one led he display of value of voltage on a LCD.  
 ...
 ![img](electronics/pcb/pictures/Battery_img/intro.png)
...
![img](electronics/pcb/pictures/Battery_img/arduino.png)
...
The circuit can be constructed on a breadboard:
  ...
  ![img](electronics/pcb/pictures/Battery_img/img5.png)
...
The circuit can be constructed on a breadboard:
   ...
   ![img](electronics/pcb/pictures/Battery_img/img6.png)


 # Adding a buzzer          

  ![img](electronics/pcb/pictures/Battery_img/img7.png)
...
The circuit :
   ...
   ![img](electronics/pcb/pictures/Battery_img/img71.png))
...
# The final Arduino Sketch
 ...
 ![img](electronics/pcb/pictures/Battery_img/img8.png)

  ![img](electronics/pcb/pictures/Battery_img/img9.png)

   ![img](electronics/pcb/pictures/Battery_img/img10.png)
...
# Burning the Bootloader
 ...
 ![img](electronics/pcb/pictures/Battery_img/img11.png)
...
# Uploading Using an Arduino Board
 ...
 ![img](electronics/pcb/pictures/Battery_img/img12.png)
...
# Schematic with proteus 8 professional
 ![img](electronics/pcb/pictures/Battery_img/img13.png)
  ![img](electronics/pcb/pictures/Battery_img/img14.png)


# The final printed circuit:
 ![img](electronics/pcb/pictures/Battery_img/img15.png)
# Issue :
